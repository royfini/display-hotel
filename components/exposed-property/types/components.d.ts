...
declare global {
    ...
    interface HTMLRfReadElement extends Components.RfRead, HTMLStencilElement {
    }
    var HTMLRfReadElement: {
        prototype: HTMLRfReadElement;
        new (): HTMLRfReadElement;
    };
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "rf-read": LocalJSX.RfRead & JSXBase.HTMLAttributes<HTMLRfReadElement>;
